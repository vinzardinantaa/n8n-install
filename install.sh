...
show_main_menu() {
    ...
    echo -e "    ${GREEN}• One-click installation with optimal settings${NC}"
    echo -e "    ${GREEN}• Auto-detects best method for your system${NC}"
    echo ""
    echo -e "${CYAN}[2]${NC} ${PACKAGE} ${WHITE}Custom Installation${NC}"
    echo -e "    ${GREEN}• Choose installation method${NC}"
    echo -e "    ${GREEN}• Configure all settings${NC}"
    echo ""
    echo -e "${CYAN}[3]${NC} ${PORT} ${WHITE}Port Management${NC}"
    echo -e "    ${GREEN}• Open/close ports${NC}"
    echo -e "    ${GREEN}• Configure firewall${NC}"
    echo ""
    echo -e "${CYAN}[4]${NC} ${SHIELD} ${WHITE}Check Port (External)${NC}"
    echo -e "    ${GREEN}• Test port accessibility${NC}"
    echo -e "    ${GREEN}• Using external API${NC}"
    echo ""
    echo -e "${CYAN}[5]${NC} ${SPEED} ${WHITE}Speed Test${NC}"
    echo -e "    ${GREEN}• Test server bandwidth${NC}"
    echo -e "    ${GREEN}• Network performance${NC}"
    echo ""
    echo -e "${CYAN}[6]${NC} ${FIRE} ${WHITE}Reinstall n8n${NC}"
    echo -e "    ${GREEN}• Clean reinstallation${NC}"
    echo -e "    ${GREEN}• Keep or reset config${NC}"
    echo ""
    ...
    echo -e "    ${GREEN}• Update & Maintenance${NC}"
    echo ""
    echo -e "${CYAN}[9]${NC} ${INFO} ${WHITE}System Information${NC}"
    echo -e "    ${GREEN}• View system specs${NC}"
